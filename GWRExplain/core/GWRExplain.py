...
import shap
import pandas as pd
from shap.maskers import Independent, Impute 
...
class GWRExplain:
    ...
    def explain(
        ...
        feature_perturbation : Literal['interventional', 'correlation_dependent']
            Feature perturbation method: 'interventional' or 'correlation_dependent'.
        """
        ...
        for idx, row in coefficients.iterrows():
            ...
            if feature_perturbation == 'interventional':
                ...
                model_tuple = (row[feature_names], row['intercept'])
